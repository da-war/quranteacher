...
const Ayah = () => {
  ...
  return (
    <View className='flex flex-1 mx-4'>
      ...
      <Text className='text-2xl font-JakartaSemiBold text-center font-JakartaBold text-primary-500'>Ayah by Ayah</Text>
     <View style={{gap:20}} className=' flex flex-row my-3'>
      <CircularProgress
          ...
          <View className='flex flex-col justify-center items-start gap-2'>
            ...
            <View className='flex flex-row gap-1 items-center' >
                ...
                <Text className='text-xs font-Jakarta' >5 language translations</Text>
            </View>
            <View className='flex flex-row gap-1 items-center' >
                <MaterialCommunityIcons name='square' size={14} color='#994EF8' />
                <Text className='text-xs font-Jakarta' >Save your progress</Text>
            </View>
            <View className='flex flex-row gap-1 items-center' >
                <MaterialCommunityIcons name='square' size={14} color='#994EF8' />
                <Text className='text-xs font-Jakarta' >Set Daily Reminder</Text>
            </View>
          </View>
      </View>  
      <View className="flex-row justify-between mb-5">
        ...
        >
          <Text numberOfLines={1} adjustsFontSizeToFit className="text-white text-center text-lg font-JakartaSemiBold">Start Reading</Text>
        </TouchableOpacity>
        <TouchableOpacity
      ...
      <View>
        ...
        <View className='flex flex-row place-items-start gap-2 my-2'>
            <MaterialCommunityIcons name='heart' size={20} color='#994EF8' />
            <Text className='text-lg'><Text className='font-JakartaBold'>Make Dua</Text> for the strength to complete your Quran journey.</Text>
        </View>
        <View className='flex flex-row place-items-start gap-2 my-2'>
            <MaterialCommunityIcons name='heart' size={20} color='#994EF8' />
            <Text className='text-lg'>Set <Text className='font-JakartaBold'>Daily Reminders</Text> so that you don't forget reading Quran.</Text>
        </View>
      </View>
        </ScrollView>
    </View>
