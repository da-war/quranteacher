  ...
  <SafeAreaView className='flex-1'>
    ...
    <View className='h-[250px] rounded-bl-[50px] rounded-br-[50px] overflow-hidden'>
      ...
      <View className='justify-center items-center py-3'>
        <Image source={{uri:teacher?.profilePicture}} className='w-[120px] h-[120px] rounded-full' contentFit='cover'  />
        <Text className='text-lg font-JakartaMedium mt-3'>{teacher?.name}</Text>
      </View>
    </View>
    </ScrollView>
    </View>
