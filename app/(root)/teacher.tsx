      ...
      <ScrollView className="p-5">
        ...
        <View className="mt-5 bg-white p-4 rounded-lg shadow-sm">
          ...
          <Text className="text-gray-600 mt-3">
            Assalamu Alaikum! I am a dedicated Quran teacher with over 10 years
            of experience in teaching Quran to students of all ages. My goal is
            to help you understand and memorize the Quran in a way that fits
            your learning style.
          </Text>
        </View>
        ...
        <View className="mt-5 bg-white p-4 rounded-lg shadow-sm">
          ...
          <View className="mt-3">
            ...
            <Text className="text-gray-600 mt-2">
              🗣️ Languages: Arabic, English, Urdu
            </Text>
          ...
          <View className="mt-3">
            {[1, 2, 3].map((review, index) => (
              <View key={index} className="mt-4">
                ...
                <Text className="text-gray-600 mt-2">
                  Teacher Name has been an excellent guide in my Quranic
                  studies. I have improved significantly in my recitation and
                  understanding.
                </Text>
              </View>
            ))}
        ...
        <View className="mt-5 bg-white p-4 rounded-lg shadow-sm mb-10">
          ...
          <View className="mt-3">
            <TouchableOpacity
              onPress={() => router.push("/contact-teacher")}
